...
CREATE TABLE T_MESSAGE (
  ...
  F_TEXT                TEXT,
  F_DATE                DATETIME(3),
  F_DELETED_BY_SENDER   BOOLEAN                  DEFAULT 0,
  F_DELETED_BY_RECEIVER BOOLEAN                  DEFAULT 0,
...
INSERT INTO T_USER (F_NAME, F_EMAIL, F_AVATAR, F_PASSWORD, F_ROLE)
VALUES ('Mark',
        'mark@tut.by',
...
VALUES ('Grisha',
        ...
        '$2a$10$MLjPrjDcmMAGltH4vY1t7eFuOTQElXtSOidopnb3gvnfT9lfeCuHS',
        'admin');
INSERT INTO T_USER (F_NAME, F_EMAIL, F_AVATAR, F_PASSWORD)
VALUES ('Vladimir',
        'vladimir@tut.by',
